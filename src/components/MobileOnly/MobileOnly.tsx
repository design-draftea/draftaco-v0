      ...
      <div className="mobile-only__content">
        <div className="mobile-only__icon">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="5" y="2" width="14" height="20" rx="2" stroke="var(--ds-fill-primary, #FBFBFB)" strokeWidth="1.5" fill="none"/>
            <circle cx="12" cy="18" r="1" fill="var(--ds-fill-primary, #FBFBFB)"/>
          </svg>
        </div>
