...
export const BETSLIP_PECHINCHA_SELECTION_RULE_LABEL = '3+ seleções acima de 1.20x'
export const BETSLIP_PECHINCHA_TOTAL_ODDS_RULE_LABEL = 'Odd total mínima 3.50x'
const BETSLIP_PECHINCHA_MESSAGE_TOTAL_ODDS_RULE_LABEL = 'odd total mínima 3.50x'
export const BETSLIP_PECHINCHA_RULE_MESSAGE = `Ofertas com Pechincha precisam de:\n${BETSLIP_PECHINCHA_SELECTION_RULE_LABEL} e ${BETSLIP_PECHINCHA_MESSAGE_TOTAL_ODDS_RULE_LABEL}`
